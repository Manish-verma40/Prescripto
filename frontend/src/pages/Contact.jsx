...
<div>
       ...
       <div className='flex my-10 flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6 '>
            ...
            <p className='text-gray-500'>Tel: (415) 555‑0132<br></br>
            Email: greatstackdev@gmail.com</p>
            <p className='font-semibold text-lg text-gray-600'>CAREERS At PRESCRIPTO</p>
            <p className='text-gray-500'>Learn more about our teams and job openings</p>
            <button className="border border-black text-sm py-4 px-8 hover:bg-primary hover:text-white transition-all duration-500">Explore Jobs</button>
        </div>
       </div>
</div>
    );
